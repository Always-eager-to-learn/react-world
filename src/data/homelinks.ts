...
export const icons: { [key: string]: IconName } = {
  chartNoAxes: "chart-no-axes-combined",
  search: "search",
  mouseClickPointer: "mouse-pointer-click",
  questionMark: "badge-question-mark",
  tally5: "tally-5",
  lightbulb: "lightbulb",
  image: "image",
