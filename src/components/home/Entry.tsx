    ...
    <section className="bg-[#f0fff4] rounded-2xl grid auto-rows-min p-4 gap-3.5 items-start">
      ...
      <section className="grid grid-cols-2 gap-4">
        ...
        <div className="row-start-2 col-start-1 col-end-3 justify-self-end">
          <Link
            to={location}
            className="flex gap-2.5 bg-[#FFB4A2] text-[#0D233D] px-5 py-2 rounded-full items-center outline-2 outline-transparent outline-offset-0 group hover:bg-[#1D2A63] hover:text-[#FFB4A2] hover:outline-[#0d233d] hover:outline-offset-2 transition-[background-color,color,outline-offset,outline-color] duration-300 ease-in"
          >
